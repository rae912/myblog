...
> 一个扬名海外的名人发布了征婚启事，一时间应者如云。每个来应征的人，都有各自的优缺点。名人由于时间有限，只能在与每位应征者短暂的接触交流后立刻决定是否与应征者继续发展亲密关系。一旦决定，则将婉拒其他未交流的应征者；而一旦犹豫，则眼前的应征者将离开，可能从此再也无法联系上。

这就是数学家的未婚妻问题，对这个问题的研究，也顺利的得到了最完美的答案。即：**以n/e为界限（n为应征者的数量，e为自然常数，约为2.718），之前所有的应征者全部拒绝，之后只要出现了比前面应征者综合条件最优的应征者相近或者更优的人，就立刻答应。**

也许你会问，这是为什么呢？那么下面就是解答的过程。如果对过程没有兴趣的话，可以直接跳到文末 **究极结论** 小节。

### 解决：数学建模
无论是“麦穗问题”还是“未婚妻问题”，本质上是一个数学模型问题，用数学符号描述如下：
...
### 究极结论
类似于“捡麦穗”和“未婚妻”问题，应该在样本总数前n/e（n>e时）设立样本区间，之后对比样本区间内的最优样本，取得最优样本的概率等于1/e（36.8%）。
